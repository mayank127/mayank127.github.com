...
function fill_grade_box(){
	...
	for(var i=0;i<grade_val.length;i++){
		...
		switch(val){
			case "AA":	grade_val[i].style.width="100%";break;
			case "AB":	grade_val[i].style.width="90%";break;
			case "BB":	grade_val[i].style.width="80%";break;
			case "BC":	grade_val[i].style.width="70%";break;
			case "CC":	grade_val[i].style.width="60%";break;
			case "CD":	grade_val[i].style.width="50%";break;
			default: if(parseFloat(val)){
